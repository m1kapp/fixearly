...
같은 자로, 예외 없이 채점했다. **2026-07-31 · 채점 규칙 v11 기준 전량 재측정.** 전체는 [랜딩](https://m1kapp.github.io/fixearly)에.
...
| nestjs | **SS** | 95 | 483파일 · 31,729줄 · 중복 7.3% |
| cypress | **SS** | 93 | 228파일 · 26,700줄 · 중복 1% |
| express | **SS** | 93 | 6파일 · 1,137줄 · 중복 0% |
| jotai | **SS** | 93 | 31파일 · 3,036줄 · 중복 1.8% |
| playwright | **SS** | 93 | 302파일 · 55,674줄 · 중복 6% |
| mongoose | **D+** | 51 | 긴 함수 6.1% · 중복 5.5% |
| nocodb | **D+** | 49 | 긴 함수 8.0% · 중복 11.9% |
| vue | **D** | 46 | 긴 함수 8.1% · 중복 1.1% |
...
> 툴링이 완충재였다. v7 에선 E+ 28점이었는데 v11 에서 45점이 됐다. 점수가 오른 건 react 가 변해서가 아니라 **자가 바뀌어서다** —
...
| **중복** | 9 | 토큰 단위 복붙 밀도. 69개 실측에서 점수와 상관 −0.11이라 배점을 16→9로 낮췄다 — 대부분엔 0점, 소수에게만 큰 항목. |
...
- **오픈소스 69개로 보정** — 유예값은 임의 임계가 아니라 코퍼스 중앙값이고, 기울기는 p90에서 캡에 닿게 잡았다. (중앙 81)
