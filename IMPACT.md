...
| `cart variant lookup O(n²)` | [medusa · 32k★](https://github.com/medusajs/medusa) | O(n²) 배열 조회 (장바구니 아이템마다 variants 선형 스캔 → Map) | [#16233](https://github.com/medusajs/medusa/pull/16233) | 🟢 open · 머지되면 +1 | — |
| `eval dataset item 반복 조회` | [langfuse · 18k★](https://github.com/langfuse/langfuse) | 중복 쿼리 (변수마다 동일 WHERE 로 같은 행 재조회 → 컬럼 합쳐 1회) | [#15585](https://github.com/langfuse/langfuse/pull/15585) | 🟢 open · 머지되면 +1 | — |
| `in-depth analytics 순차 await` | [typebot · 9k★](https://github.com/baptisteArno/typebot.io) | 독립 순차 await (독립 groupBy 3개 직렬 → Promise.all, 합→최댓값) | [#2572](https://github.com/baptisteArno/typebot.io/pull/2572) | 🟢 open · 머지되면 +1 | — |
