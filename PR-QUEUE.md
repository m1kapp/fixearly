...
지금 머지 0인 축: `N+1`(보류 2) · `중복 쿼리`(보류 1) · `쓰기만 하는 컬렉션`(대기 1).
...
**열린 것 9건(보류 5건 빼면 4건).** 판정 난 12건 중 머지 7 · 승인 0 · 닫힘 5.
<!-- /auto:open -->
...
**2026-08-08 부터 상한이 다시 열렸다** — 보류를 빼고 세면 붙잡고 있는 건 4건이다.
나머지는 저장소당 1건·하루 1건으로 꺼낸다.
